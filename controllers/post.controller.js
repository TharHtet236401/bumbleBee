    ...
    try {
        ...
        if (
            ...
            try {
                ...
                return next(
                    new Error(`File upload failed: ${uploadError.message}`)
                );
            }
        }
    ...
    try {
        ...
        if (
            ...
            try {
                ...
                return next(
                    new Error(
                        `Content picture operation failed: ${uploadError.message}`
                    )
                );
            }
        }
        ...
        if (req.files && req.files.documents) {
            try {
                ...
                return next(
                    new Error(
                        `Documents operation failed: ${uploadError.message}`
                    )
                );
            }
        }
